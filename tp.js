onload = function () {
    ...
    function createData(){
        sz = Math.floor(Math.random() * 15) + 6;
        const cities = ['Delhi', 'Indore', 'Bihar', 'Jaipur', 'Gwalior', 'Bhopal', 'Lucknow', 'Kolkata', 'Ranchi', 'Sikkim', 'Chennai', 'Mumbai', 'Ahemdabad', 'Patna', 'Kanpur', 'Jammu', 'Hyderabad', 'Bangalore', 'Gangtok', 'Meghalaya'];
        let nodes = [];
        for(let i=1;i<=sz;i++){
